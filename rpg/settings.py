...
SECRET_KEY = 'django-insecure-1n8z+*ouzb5(b(&8hzv9=)py4*e5b_#+23d=lyj8x91m_!292q'
...
EMAIL_HOST_USER = 'lutsckov.o'  # ваше имя пользователя, это всё то что идёт до собаки.
...
SERVER_EMAIL = 'lutsckov.o@yandex.ru'
##############
